...
import com.jasonstanl3y.instaparseagram.activities.LoginActivity;
import com.jasonstanl3y.instaparseagram.activities.MainActivity;
    ...
    private void savePost(String description, ParseUser parseUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e != null) {
                    Log.d(TAG, "Error in saving data");
                    e.printStackTrace();
                    return;
                }
                Log.d(TAG, "Success!");
